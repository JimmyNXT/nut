/* esp.h - NUT testing driver and repeater
...
#ifndef NUT_ESP_UPS_H_SEEN
#define NUT_ESP_UPS_H_SEEN 1
...
static dummy_info_t nut_data[] =
{
	...
	{ "ups.mfr", ST_FLAG_STRING | ST_FLAG_RW, 32, "Mtech Consulting", DU_FLAG_INIT, NULL },
	{ "ups.model", ST_FLAG_STRING | ST_FLAG_RW, 32, "ESP API UPS", DU_FLAG_INIT, NULL },
